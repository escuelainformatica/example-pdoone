...
class dBug
{
     ...
     * @param bool    $varType
     * @param string  $notempty=['no','notempty','notnull'][$i]
     *
     * @throws ReflectionException
     * @noinspection PhpUnhandledExceptionInspection
     */
    public function __construct($var, $forceType = "", $bCollapsed = false, $varType = true,$notempty='no') {
    ...
    public function varIsArray(&$var) {
        ...
        if (is_array($var)) {
            foreach ($var as $key => $value) {
                if($value!=null || $this->notEmpty==='no') {
